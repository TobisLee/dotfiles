...
link_file "fish/completions/opencode.fish"  "$HOME/.config/fish/completions/opencode.fish"
cp "$HOME/.dotfiles/public/fish/config.fish"  "$HOME/.config/fish/config.fish"
